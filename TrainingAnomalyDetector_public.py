...
from network.fc_layer import AnomalyDetector, custom_objective, RegularizedLoss
...
if __name__ == "__main__":
    ...
    # Data loader
    train_loader = FeaturesLoader(features_path=args.features_path, features_file_name=args.features_file, annotation_path=args.annotation_path, extractor_type=args.extractor_type)
